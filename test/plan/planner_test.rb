...
require_relative './../../src/plan/basic_query_planner'
require_relative './../../src/plan/planner'
require_relative './../../src/server/simple_ruby_db'
...
class PlannerTest < Minitest::Test
  def test_basic_query_planner
    ...
    db = SimpleRubyDb.new(temp_file, temp_meta_file, query_planner: 'basic')
